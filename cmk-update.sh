...
patchlevel=46 # set this to your desired patchlevel
...
wget https://download.checkmk.com/checkmk/2.2.0p$patchlevel/check-mk-raw-2.2.0p$patchlevel$subpatchlevel.$current_codename
